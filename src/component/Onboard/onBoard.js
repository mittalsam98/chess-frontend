...
const OnBoard = () => {
    ...
    function send() {
        ...
        const data = { gameId: newGameId, userName: userName, orientationColor: userContext.orientationColor }
    ...
    return (
        <div className={classes.container} component="main" maxWidth="xs">
            {didGetUserName ? <Redirect to={"/game/" + gameId}><button>ssss</button></Redirect>
                :
